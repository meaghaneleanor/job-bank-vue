export default {
  ...
  'footer': {
    'info': 'The Government of Ontario includes ministries, agencies and Crown corporations.',
    'topics': 'Topics',
    'contact': 'Contact Us',
    'links': [
      {
        'title': 'about Ontario',
        'href': 'https://www.ontario.ca/page/about-ontario'
      },
      {
        'title': 'accessibility',
      ...
      { 
        'title': 'news',
        'href': 'https://news.ontario.ca/newsroom/en'
      },
      {
