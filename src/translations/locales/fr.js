export default {
  ...
  'footer': {
    'info': 'Le gouvernement de l’Ontario inclut les ministères, organismes et sociétés de la Couronne.',
    'topics': 'Sujets',
    'contact': 'Contactez-nous',
    'links': [
      {
        'title': 'l\'Ontario en bref',
        'href': 'https://www.ontario.ca/fr/page/lontario-en-bref'
      },
      {
        'title': 'accessibilité',
        'href': 'https://www.ontario.ca/fr/page/accessibilite'
      },
      { 
        'title': 'nouvelles',
        'href': 'https://news.ontario.ca/newsroom/fr'
      },
      {
  ...
  'jobPage': {
    'salaryString': 'Salaire: ',
    'detailsButton': 'Détails du poste',
    'newFlag': 'Nouveau'
  }   
};
